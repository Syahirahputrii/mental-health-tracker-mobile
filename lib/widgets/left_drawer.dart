...
import 'package:mental_health_tracker/screens/list_moodentry.dart'; // Import halaman list_moodentry
      ...
      child: ListView(
        children: [
          ...
          ListTile(
            ...
            onTap: () {
              // Route ke halaman daftar mood
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => const MoodEntryPage(), // Halaman list_moodentry
                ),
              );
            },
          ),
